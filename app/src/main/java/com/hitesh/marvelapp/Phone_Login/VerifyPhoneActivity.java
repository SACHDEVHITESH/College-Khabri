package com.hitesh.marvelapp.Phone_Login;
...
import com.hitesh.marvelapp.InstructionsActivity;
import com.hitesh.marvelapp.R;
import com.hitesh.marvelapp.UserSection;
                ...
                .addOnCompleteListener(VerifyPhoneActivity.this, new OnCompleteListener<AuthResult>() {
                    ...
                    public void onComplete(@NonNull Task<AuthResult> task) {
                        if (task.isSuccessful()) {
                            ...
                            Intent intent = new Intent(VerifyPhoneActivity.this, InstructionsActivity.class);
